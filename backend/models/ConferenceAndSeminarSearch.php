...
/**
 * ConferenceAndSeminarSearch represents the model behind the search form of `app\models\ConferenceAndSeminar`.
 */
class ConferenceAndSeminarSearch extends ConferenceAndSeminar
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ConferenceAndSeminar::find();
