...
/**
 * MemberProfessionalBodySearch represents the model behind the search form of `app\models\MemberProfessionalBody`.
 */
class MemberProfessionalBodySearch extends MemberProfessionalBody
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MemberProfessionalBody::find();
