...
/**
 * MemberScientificProfessionalBodySearch represents the model behind the search form of `app\models\MemberScientificProfessionalBody`.
 */
class MemberScientificProfessionalBodySearch extends MemberScientificProfessionalBody
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MemberScientificProfessionalBody::find();
