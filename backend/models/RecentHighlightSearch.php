...
/**
 * RecentHighlightSearch represents the model behind the search form of `app\models\RecentHighlight`.
 */
class RecentHighlightSearch extends RecentHighlight
{
    /**
     * {@inheritdoc}
     */
