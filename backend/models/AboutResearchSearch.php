...
/**
 * AboutResearchSearch represents the model behind the search form of `app\models\AboutResearch`.
 */
class AboutResearchSearch extends AboutResearch
{
    /**
     * {@inheritdoc}
     */
